...
public class DialogHelper {
    public static void Teclado(TextView view, String texto, Context context,DialogInterface dialogInterface) {
    ...
    public static void TecladoFlotante(TextView view, String texto, Context context,DialogInterface dialogInterface) {
        LayoutInflater inflater = LayoutInflater.from(context);
    ...
    public static void TecladoEntero(TextView view, String texto, Context context,DialogInterface dialogInterface) {
        LayoutInflater inflater = LayoutInflater.from(context);
        DialogoDosopcionespuntosBinding dialogBinding = DialogoDosopcionespuntosBinding.inflate(inflater);
