...
public class AdapterConfigDinamico extends RecyclerView.Adapter<AdapterConfigDinamico.ViewHolder> {
    ...
    public AdapterConfigDinamico(Context context, List<String> data) {
