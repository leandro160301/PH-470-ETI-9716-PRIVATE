...
public class OPTIMA_ID_I implements Balanza, Balanza.Struct, Serializable {
    ...
    public OPTIMA_ID_I context;
    public BalanzaService service;

    public OPTIMA_ID_I(PuertosSerie serialPort, int numero, AppCompatActivity activity, BalanzaService service,int cantidad) {
