...
public class PreferencesManager {
    ...
    public long getRecetaId() {
        SharedPreferences Preferencias = context.getSharedPreferences(SP_NAME, Context.MODE_PRIVATE);
        long id=Preferencias.getLong("RecetaID", 0);
        return id;
    }
    ...
    public long getPedidoId() {
        SharedPreferences Preferencias = context.getSharedPreferences(SP_NAME, Context.MODE_PRIVATE);
        long id=Preferencias.getLong("PedidoID", 0);
        return id;
    }
    ...
    public int getTurno1() {
        SharedPreferences Preferencias=context.getSharedPreferences(SP_NAME, Context.MODE_PRIVATE);
        int url =(Preferencias.getInt("turno1",8));
        return url;
    }
    ...
    public int getTurno2() {
        SharedPreferences Preferencias=context.getSharedPreferences(SP_NAME, Context.MODE_PRIVATE);
        int url =(Preferencias.getInt("turno2",13));
        return url;
    }
    ...
    public int getTurno3() {
        SharedPreferences Preferencias=context.getSharedPreferences(SP_NAME, Context.MODE_PRIVATE);
        int url =(Preferencias.getInt("turno3",17));
        return url;
    }
    ...
    public int getTurno4() {
        SharedPreferences Preferencias=context.getSharedPreferences(SP_NAME, Context.MODE_PRIVATE);
        int url =(Preferencias.getInt("turno4",21));
        return url;
    }
    ...
    public int getPasoActual() {
        SharedPreferences Preferencias = context.getSharedPreferences(SP_NAME, Context.MODE_PRIVATE);
        int a=(Preferencias.getInt("PasoActual", 0));
        return a;
    }
    ...
    public String getNetototal() {
        SharedPreferences Preferencias = context.getSharedPreferences(SP_NAME, Context.MODE_PRIVATE);
        String a=Preferencias.getString("Netototal", "0");
        return a;
    }
    ...
    public String getNombreRecetaactual() {
        SharedPreferences Preferencias = context.getSharedPreferences(SP_NAME, Context.MODE_PRIVATE);
        String a=(Preferencias.getString("NombreRecetaactual", ""));
        return a;
    }
    ...
    public String getCodigoRecetaactual() {
        SharedPreferences Preferencias = context.getSharedPreferences(SP_NAME, Context.MODE_PRIVATE);
        String a=(Preferencias.getString("CodigoRecetaactual", ""));
        return a;
    }
    ...
    public String getEtiqueta(int etiqueta) {
        SharedPreferences Preferencias=context.getSharedPreferences(SP_NAME, Context.MODE_PRIVATE);
        String url =(Preferencias.getString("etiqueta_actual_"+String.valueOf(etiqueta),""));
        return url;
    }
    ...
    public String getSeparador(String etiqueta,int posicion) {
        SharedPreferences Preferencias=context.getSharedPreferences(SP_NAME, Context.MODE_PRIVATE);
        String url =(Preferencias.getString(etiqueta+"_concat_separador_"+posicion,","));
        return url;
    }
