...
import com.jws.jwsapi.general.formulador.ui.fragment.FormFragmentDatos;
import com.jws.jwsapi.general.formulador.ui.fragment.FormFragmentConfiguracionBalanza;
import com.jws.jwsapi.general.formulador.ui.fragment.FormFragmentConfiguracionPrograma;
import com.jws.jwsapi.general.formulador.ui.fragment.FormFragmentConfiguracionTurnos;
...
public class MenuFragment extends Fragment implements AdapterConfig.ItemClickListener {
    ...
    AdapterConfigDinamico adapterDinamicos1, adapterDinamicos2;
    String pin="error";
    ...
    private void initializeViews(View view) {
        ...
        adapter = new AdapterConfig(getContext(), ListElementsArrayList);
    ...
    public void CargarDatosADinamico(List<String> lista){
        ...
        adapterDinamicos1 = new AdapterConfigDinamico(getContext(), lista);
    ...
    public void CargarDatosADinamico2(List<String> lista){
       // lastVisiblePosition2=-1;
        ...
        adapterDinamicos2 = new AdapterConfigDinamico(getContext(), lista);
