...
public class ImprimirPDFRed {

    private static ImprimirPDFRed.PrintListener printListener;
    ...
    public static void printPDFFile(final String printerIP, final int printerPort,
                                    final File file, final String filename, final ImprimirPDFRed.PaperSize paperSize, final int copies) {
    ...
    public static void setPrintListener(ImprimirPDFRed.PrintListener list) {
        printListener = list;
    }
