...
import com.jws.jwsapi.base.adapters.MyRecyclerViewAdapterEtiquetasDePrograma;
import com.jws.jwsapi.R;
import com.jws.jwsapi.base.models.EtiquetasDeProgramaModel;
import com.jws.jwsapi.common.impresora.PrinterHelper;
...
public class EtiquetasDePrograma extends Fragment implements MyRecyclerViewAdapterEtiquetasDePrograma.ItemClickListener {

    Button bt_home,bt_1,bt_2,bt_3,bt_4,bt_5,bt_6;
    MainActivity mainActivity;
    private ButtonProvider buttonProvider;
    private int lastVisiblePosition1 = -1;
    MyRecyclerViewAdapterEtiquetasDePrograma adapter;
    ...
    private void cargarRecyclerView(){
        ...
        PrinterHelper printerHelper=new PrinterHelper(mainActivity,new PreferencesPrinterManager(mainActivity));
        adapter = new MyRecyclerViewAdapterEtiquetasDePrograma(getContext(),lista_ingredientes,mainActivity,printerHelper.getEtiquetasPRN());
    ...
    public void onItemClick(View view, int position) {
       ...
       // cargarRecyclerViewReceta(archivos.get(position));
        //mainActivity.mainClass.recetaActual=archivos.get(posicion_recycler);

    }

    @Override
    public void onDestroyView() {
        if(posicion_recycler!=-1){
