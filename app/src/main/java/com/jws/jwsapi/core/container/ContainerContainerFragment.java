...
@AndroidEntryPoint
public class ContainerContainerFragment extends Fragment implements ContainerButtonProvider {
    ...
    public static ContainerContainerFragment newInstance(Class<? extends Fragment> fragmentClass) {
        ContainerContainerFragment fragment = new ContainerContainerFragment();
