...
public class MyRecyclerViewAdapterMultimedia2 extends RecyclerView.Adapter<MyRecyclerViewAdapterMultimedia2.ViewHolder> {
    ...
    public MyRecyclerViewAdapterMultimedia2(Context context, List<String> data) {
