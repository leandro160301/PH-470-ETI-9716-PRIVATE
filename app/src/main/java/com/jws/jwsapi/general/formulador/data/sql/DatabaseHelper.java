...
public class DatabaseHelper extends  SQLiteOpenHelper {
    ...
    public void actualizarNetoTotalReceta(String netototal, String id) {
        SQLiteDatabase db = this.getWritableDatabase();
        try {
            db.beginTransaction();
    ...
    public void actualizarNetoTotalPedido(String netototal, String id) {
        SQLiteDatabase db = this.getWritableDatabase();
        try {
            db.beginTransaction();
    ...
    public List<FormModelPesadasDB> getPesadasSQL(Map<String, List<String>> filtros) {
        List<FormModelPesadasDB> filas = new ArrayList<>();
        SQLiteDatabase db = this.getReadableDatabase();
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                FormModelPesadasDB fila = new FormModelPesadasDB(
                        id, idReceta, idPedido, codigoReceta, descripcionReceta, codigoIngrediente, descripcionIngrediente,
                        lote, vencimiento, turno, neto, bruto, tara, fecha, hora, campo1, campo2, campo3,
                        campo4, campo5, campo1Valor, campo2Valor, campo3Valor, campo4Valor, campo5Valor,
                        operador, setPoint, reales, campoExtra1, campoExtra2,balanza
    ...
    public List<FormModelPesadasDB> getPesadasSQLconId(String ID, Boolean receta) {
        List<FormModelPesadasDB> filas = new ArrayList<>();
        SQLiteDatabase db = this.getReadableDatabase();
        String query="";
    ...
    public List<FormModelRecetaDB> getRecetasSQL(Map<String, List<String>> filtros) {
        List<FormModelRecetaDB> filas = new ArrayList<>();
        SQLiteDatabase db = this.getReadableDatabase();
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                FormModelRecetaDB fila = new FormModelRecetaDB(
    ...
    public List<FormModelRecetaDB> getPedidosSQL(Map<String, List<String>> filtros) {
        List<FormModelRecetaDB> filas = new ArrayList<>();
        SQLiteDatabase db = this.getReadableDatabase();
