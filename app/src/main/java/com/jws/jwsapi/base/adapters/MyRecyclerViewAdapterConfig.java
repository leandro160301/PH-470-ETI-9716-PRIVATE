...
public class MyRecyclerViewAdapterConfig extends RecyclerView.Adapter<MyRecyclerViewAdapterConfig.ViewHolder> {
    ...
    public MyRecyclerViewAdapterConfig(Context context, List<String> data, MainActivity mainActivity) {
