...
public class FormAdapterGuardadosPesadas extends RecyclerView.Adapter<FormAdapterGuardadosPesadas.ViewHolder> {


    private int selectedPos = RecyclerView.NO_POSITION;
    private List<FormModelPesadasDB> mData;
    ...
    public FormAdapterGuardadosPesadas(Context context, List<FormModelPesadasDB> data) {
    ...
    public void filterList(ArrayList<FormModelPesadasDB> filteredList) {
        mData = filteredList;
