...
public class InitServer {
    ...
    public InitServer(Context context, MainActivity mainActivity, UserManager userManager, PreferencesManager preferencesManager, WeighingService weighingService) {
