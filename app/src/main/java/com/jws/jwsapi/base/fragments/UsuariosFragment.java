...
import com.jws.jwsapi.base.adapters.MyRecyclerViewAdapterUsuarios;
...
public class UsuariosFragment extends Fragment implements MyRecyclerViewAdapterUsuarios.ItemClickListener {
    ...
    MyRecyclerViewAdapterUsuarios adapter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new MyRecyclerViewAdapterUsuarios(getContext(), ListElementsArrayList,mainActivity);
