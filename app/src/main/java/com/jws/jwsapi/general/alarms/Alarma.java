package com.jws.jwsapi.general.alarms;
...
public class Alarma<T> {
    ...
    public Alarma(int id, MainActivity mainActivity, Context context) {
    ...
    public void startNumeric(ObjetoAlarma alarma, Condicion condicion){
        tipoalarma=0;
        estado=getEstado();
    ...
    public void start(ObjetoAlarma alarma,T value){
        tipoalarma=1;
        this.value = value;
        estado=getEstado();
        Handler handler = new Handler();
