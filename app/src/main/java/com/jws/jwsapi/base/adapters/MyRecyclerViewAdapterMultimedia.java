...
public class MyRecyclerViewAdapterMultimedia extends RecyclerView.Adapter<MyRecyclerViewAdapterMultimedia.ViewHolder> {
    ...
    public MyRecyclerViewAdapterMultimedia(Context context, List<String> data,MainActivity mainActivity) {
