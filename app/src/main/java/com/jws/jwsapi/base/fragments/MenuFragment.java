...
import com.jws.jwsapi.base.adapters.MyRecyclerViewAdapterConfig;
import com.jws.jwsapi.base.adapters.MyRecyclerViewAdapterConfigDinamico;
...
public class MenuFragment extends Fragment implements MyRecyclerViewAdapterConfig.ItemClickListener {
    ...
    MyRecyclerViewAdapterConfig adapter;
    JwsManager jwsManager;
    MyRecyclerViewAdapterConfigDinamico adapterDinamicos1, adapterDinamicos2;
    String pin="error";
    ...
    private void initializeViews(View view) {
        ...
        adapter = new MyRecyclerViewAdapterConfig(getContext(), ListElementsArrayList,mainActivity);
    ...
    public void CargarDatosADinamico(List<String> lista){
        ...
        adapterDinamicos1 = new MyRecyclerViewAdapterConfigDinamico(getContext(), lista,mainActivity);
        ...
        adapterDinamicos1.setClickListener((view, position) -> {
            ...
            if(menuElegido ==1){
                if(mainActivity.getNivelUsuario()>1){
                    ...
                    if(position==4){
                        mainActivity.mainClass.openFragment(new EtiquetasDePrograma());
                    }
                }else{
                    Utils.Mensaje("Debe ingresar la clave para acceder a esta configuracion",R.layout.item_customtoasterror,mainActivity);
                }
    ...
    public void CargarDatosADinamico2(List<String> lista){
       // lastVisiblePosition2=-1;
        ...
        adapterDinamicos2 = new MyRecyclerViewAdapterConfigDinamico(getContext(), lista,mainActivity);
        ...
        adapterDinamicos2.setClickListener((view, position) -> {
            if(menuElegido ==5){
                if(mainActivity.getNivelUsuario()>1){
                    if(menuElegido2==0){
                        if(position==0){
                            mainActivity.mainClass.openFragment(new ImpresorasConfiguracion());

                        }
                        if(position==1){
                            mainActivity.mainClass.openFragment(new ImpresorasEtiquetas());
                        }
                    }
                }
                else{
